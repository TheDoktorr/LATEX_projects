       ...
       \begin{figure}[]
        \begin{center}
            ...
            \includesvg[height=8.0cm]{histogram_new.svg}
             \caption{“Figure 2 illustrates the Poisson curve, fit on top of the histogram with associated error bars. The Possion's parameter was calculated as, and $\sigma_{hist} = $”}
